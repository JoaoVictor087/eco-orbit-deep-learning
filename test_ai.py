...
def escanear_imagem_satelite(caminho_imagem, caminho_saida):
    ...
    try:
        ...
        print(f"🗺️ Mapa salvo com marcações em: {caminho_saida}")
...
if __name__ == "__main__":
    imagem_entrada = "image_tests/incendio-africa.jpg"
    imagem_saida = "analises/incendio-africa.jpg"

    if os.path.exists(imagem_entrada):
        escanear_imagem_satelite(imagem_entrada, imagem_saida)
    else:
        print(f"⚠️ Imagem '{imagem_entrada}' não encontrada. Salve o link da NASA nesta pasta com esse nome!")